...
export default function Explore() {
  ...
  const fetchSnippets = () => {
    fetch(`https://snipscript-3.wl.r.appspot.com/api/explore`, {
      method: "GET",
      headers: {
  ...
  const fetchTags = () => {
    fetch(`https://snipscript-3.wl.r.appspot.com/api/explore/popular-tags`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleSearch = (query) => {
    console.log(query);
    fetch(`https://snipscript-3.wl.r.appspot.com/api/explore/search/${query}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const fetchTrendingSnippets = () => {
    ...
    fetch(`https://snipscript-3.wl.r.appspot.com/api/explore/trending`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
